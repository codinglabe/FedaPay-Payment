            ...
            <div class="card bg-white shadow border-0">
              ...
              <div class="card-body px-lg-5 py-lg-5 position-relative">
                ...
                <form method="post" action="{{url('send/tip')}}" id="formSendTip">
                  ...
                  <div class="custom-control custom-radio mb-3">
                    <input name="payment_gateway_tip" @if (Helper::userWallet() == 0) disabled @endif value="wallet" id="tip_radio0" class="custom-control-input" type="radio">
            ...
            <div class="card bg-white shadow border-0">
              ...
              <div class="card-body px-lg-5 py-lg-5 position-relative">
                ...
                <form method="post" action="{{url('send/ppv')}}" id="formSendPPV">
                  ...
                  @if ($settings->disable_wallet == 'on' && Helper::userWallet() != 0.00 || $settings->disable_wallet == 'on' && Helper::userWallet() != 0 || $settings->disable_wallet == 'off')
                  <div class="custom-control custom-radio mb-3">
                    <input name="payment_gateway_ppv" @if (Helper::userWallet() == 0) disabled @endif value="wallet" id="ppv_radio0" class="custom-control-input" type="radio">
